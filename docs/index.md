...
Last refreshed: 2026-05-09 EOD+108 (**R4 #6 W4A16BatchGemv override KILLED `3b9cc06` empirical bench +37% ITL regression** — Marlin tensor-core utilization wins over launch-overhead savings,hypothesis empirically eliminated;**P0.2 Hybrid W4 Marlin loader LANDED `232aed5`** GuideLLM smoke PASS TTFT p50 68.4ms ITL p50 14.02ms 0 errors;**B3 Step 2 PrefixAwareAdmission LANDED `b85929b` LICENSED -24.2% TTFT** σ/mean 4.5% N=5 paired post-Round-4; W4A8 GPTQ-zpfix LANDED `2a3a6f0` greedy 32/32 0% diff; W3/W4 admission deadlock unblocked `b708e00`; cap=8 default `12300c5`(real fix per 7-layer audit `3fea979`); B3 Step 1 admission_allows `7c8fd61`; skill v1.7.0 with 19 anti-patterns + **v1.8.0 batch deferred 6 candidates ready**(#20 hypothesis-inheritance / #21 recipe-itself / #22 twin-commit attribution / #23 truncated-output partial-view / #24 cell-collapse blindness / **#25 hypothesis-context vs implementation-context mismatch**); **30-stage bidirectional audit cycle CLOSED `cca6bb0` + R4 #6 6-stage micro-cycle CLOSED via empirical KILL**; 8-layer SOLID audit chain on c20b1ce attribution closed;**4-cell A/B simplifies to 1 experiment** post-P0.2 cell-collapse `1ccb448`; 180+ commits since 2026-05-08 EOD). Priority order canonical in [`ROADMAP.md` §Next-Model Priority Order](../ROADMAP.md#next-model-priority-order). Anchor doc for resumption: [`docs/research/2026-05-08-eod67-final-state-anchor.md`](research/2026-05-08-eod67-final-state-anchor.md). Pickup queue: [`docs/plans/codex-pickup-queue-2026-05-09.md`](plans/codex-pickup-queue-2026-05-09.md)(`3fd52ce`,**2 paths queued post-R4#6-KILL**:(a)P0.0 Phase 1.A nvtx decomposition recipe `2fafa9e`+`b55bfcd`(b)cell (d) 1-experiment ~30min `1bf408d`).
